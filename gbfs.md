...
\-&nbsp;`region_id` | OPTIONAL | ID | Identifier of the region where vehicle is currently located. See [system_regions.json](#system_regionsjson).
...
Describes regions within a single system. Regions may be used to divide a system along geographic, political or other lines. 
